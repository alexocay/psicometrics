const data = [{
    ...
    },
    {
        ...
        question: { id:12, text:'12. Un avión vuela 300 metros en ½ segundo. A esta misma velocidad, ¿Cuántos metros recorrerá en 10 segundos?'}, answers: [{id:1, name:'null'}], image:'0' 
    }, {
        ...
        question: { id:15, text:'15. Se venden limones a 3 por 10 centavos. ¿Cuánto costara una docena y media?'}, answers: [{id:1, name:'null'}], image:'0' 
    }, {
        question: { id:16, text:'16. ¿Cuántas de las 5 cantidades abajo indicadas son identicas una a la otra?'}, answers: [{id:1, name:'null'}], image:'../../assets/img/16.JPG' 
    }, {
        question: { id:17, text:'17. Imagine usted que acomoda las siguientes palabras de modo que hagan una afirmación cierta, luego escriba la última letra de la última palabra como respuesta a este problema. Siempre un verbo oración una tiene.'}, answers: [{id:1, name:'null'}], image:'0' 
    },{
        question: { id:18, text:'18. Un niño de 5 años tiene una hermana que es de doble edad que él. Cuando el niño tenga 8 años, ¿Cuál será la edad de su hermana?.'}, answers: [{id:1, name:'null'}], image:'0' 
    }, {
        ...
        question: { id:21, text:'21. Un negociante compro varios coches por $4000°°, los vendió en $500°°, ganando $50°° en cada coche. ¿Cuántos coches compro?.'}, answers: [{id:1, name:'null'}], image:'0' 
    }, {
        ...
        question: { id:23, text:'23. Dos de los siguientes proverbios tienen igual significado. ¿Cuáles son?.'}, answers: [{id:1, name:'null'}], image:'../../assets/img/23.JPG' 
    }, {
        question: { id:24, text:'24. Un reloj se atrasa 1 minuto 18 segundos en 39 días. ¿Cuántos segundos se atrasa por día?.'}, answers: [{id:1, name:'null'}], image:'0' 
    }, {
        ...
        question: { id:27, text:'27. EN 30 días un niño ahorró $1.°° ¿Cuál fue su promedio de ahorro diario?'}, answers: [{id:1, name:'null'}], image:'0' 
    }, {
        ...
        question: { id:29, text:'29. 2 hombres pescaron 26 pescados: "X" pesco 5 veces lo que "Y". ¿Cuántos pesco "Y"?.'}, answers: [{id:1, name:'null'}], image:'0' 
    }, {
        question: { id:30, text:'30. Un depósito rectangular, completamente lleno, contiene 800 metros cúbicos de granos. Si el depósito tiene 8 metros de ancho y 10 metros de largo. ¿Cuántos metros de profundidad tiene?'}, answers: [{id:1, name:'null'}], image:'0' 
    }, {
        question: { id:31, text:'31. Uno de los siguientes números de la siguiente serie no encaja en la serie. ¿Cuál debe de estar en su lugar?'}, answers: [{id:1, name:'null'}], image:'../../assets/img/31.JPG' 
    }, {
        ...
        question: { id:34, text:'34. Una falda necesita 2 ¼ metros de tela. ¿Cuántas faldas pueden hacerse de 45 metros?'}, answers: [{id:1, name:'null'}], image:'0' 
    }, {
        ...
        question: { id:36, text:'36. Nuestro equipo de béisbol perdió 9 juegos en esta temporada. Esto fue 3/8 de lo que jugaron. ¿Cuántos juegos jugaron en esta temporada?'}, answers: [{id:1, name:'null'}], image:'0' 
    }, {
        question: { id:37, text:'37. ¿Cuál es el número que le sigue a los siguientes? 1 .5 .25 .125'}, answers: [{id:1, name:'null'}], image:'0' 
    }, {
        question: { id:38, text:'38. Esta es una figura geométrica puede ser dividida en dos partes por una línea recta, y estas pueden unirse de manera que formen un cuadrado perfecto. Trace mentalmente la línea uniendo los números y luego escriba esos números'}, answers: [{id:1, name:'null'}], image:'../../assets/img/38.JPG' 
    }, {
        ...
        question: { id:40, text:'40. De los 5 nombres citados, ¿Cuántos tienen igual significado'}, answers: [{id:1, name:'null'}], image:'../../assets/img/40.JPG' 
    }, {
        question: { id:41, text:'41. Dos de los Proverbios abajo citados tienen igual significado, ¿Cuáles son?'}, answers: [{id:1, name:'null'}], image:'../../assets/img/41.JPG' 
    }, {
        question: { id:42, text:'42. Esta figura geométrica puede dividirse en dos partes, de tal manera que al unirla de cierto modo hace un cuadro perfecto. Dibuje dicha línea mentalmente juntando dos de los números, después escriba los números que den el resultado correcto.'}, answers: [{id:1, name:'null'}], image:'../../assets/img/42.JPG' 
    }, {
        question: { id:43, text:'43. ¿Cuál de los numeros de este grupo representa la cantidad más pequeña? 10 1 .99 .33 11'}, answers: [{id:1, name:'null'}], image:'0' 
    }, {
